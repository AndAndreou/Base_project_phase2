...
public class test5 : MonoBehaviour {
	...
	void OnGUI() {
		if (GUI.Button(new Rect((Screen.width/2)-75/2, (Screen.height/2)-50/2, 150, 100), "I am a button"))
			print("You clicked the button!");

		GUI.DrawTexture (new Rect ((Screen.width / 2) - 75 / 2, (Screen.height / 2) - 50 / 2, 150, 100), texture[frame]);
	}
}
